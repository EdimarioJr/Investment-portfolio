...
export default function Dashboard() {
  ...
  const [totalBalance, setTotalBalance] = useState(85);
  const [dailyChange, setDailyChange] = useState(2.6);
  const [portfolioGrowth, setPortfolioGrowth] = useState(18.4);
  ...
  useEffect(() => {
    const interval = setInterval(() => {
      setTotalBalance((prev) => prev + (Math.random() * 2 - 1));
      setDailyChange((prev) => Math.max(0, prev + (Math.random() * 1 - 0.5)));
      setPortfolioGrowth((prev) => prev + (Math.random() * 1 - 0.5));
    }, 3000);
            ...
            <Card className="bg-slate-900/50 border-slate-700/50 backdrop-blur-sm h-full">
              <CardContent className="p-4">
                <nav className="space-y-2">
                  <NavItem icon={Wallet} label="Overview" active />
                  <NavItem icon={BarChart3} label="Portfolio" />
                  <NavItem icon={ArrowDownUp} label="Transactions" />
                  <NavItem icon={PlusCircle} label="Buy / Sell" />
                  <NavItem icon={Send} label="Send / Receive" />
                  <NavItem icon={Landmark} label="Staking" />
                ...
                <div className="mt-8 pt-6 border-t border-slate-700/50">
                  ...
                  <div className="space-y-3">
                    <StatusItem label="Bitcoin" value={65} color="amber" />
                    <StatusItem label="Ethereum" value={78} color="cyan" />
                    <StatusItem label="Market" value={42} color="green" />
                  </div>
                </div>
              </CardContent>
            </Card>
          ...
          <div className="col-span-12 md:col-span-9 lg:col-span-7">
            <div className="grid gap-6">
              ...
              <Card className="bg-slate-900/50 border-slate-700/50 backdrop-blur-sm">
                <CardHeader className="pb-2">
                  <CardTitle className="text-slate-100 flex items-center text-base">
                    <ArrowDownUp className="mr-2 h-5 w-5 text-green-500" />
                    Recent Transactions
                  </CardTitle>
                </CardHeader>
                <CardContent>
                ...
                <CardHeader className="pb-2 flex flex-row items-center justify-between">
                  ...
                  <div className="flex space-x-2">
                    ...
                    <Button
                      variant="outline"
                      size="sm"
                      className="h-8 border-cyan-700 bg-cyan-900/20 text-cyan-400 hover:bg-cyan-800/30"
                    >
                      1M
                    </Button>
                    <Button
              ...
              <Card className="bg-slate-900/50 border-slate-700/50 backdrop-blur-sm">
                ...
                <CardContent>
                  <div className="grid grid-cols-2 gap-3">
                    ...
                    <ActionButton icon={PlusCircle} label="Buy" />
                    <ActionButton icon={Landmark} label="Stake" />
                  </div>
                </CardContent>
              </Card>
                  ...
                  <div className="space-y-4">
                    <div>
                      <div className="flex items-center justify-between mb-1">
                        ...
                        <div className="text-xs text-amber-400">58%</div>
                      </div>
                    ...
                    <div>
                      <div className="flex items-center justify-between mb-1">
                        ...
                        <div className="text-xs text-cyan-400">25%</div>
                      </div>
                      <div className="h-2 bg-slate-800 rounded-full overflow-hidden">
                        <div
                    ...
                    <div>
                      <div className="flex items-center justify-between mb-1">
                        ...
                        <div className="text-xs text-purple-400">12%</div>
                      </div>
                      <div className="h-2 bg-slate-800 rounded-full overflow-hidden">
                        <div
                    ...
                    <div>
                      <div className="flex items-center justify-between mb-1">
                        <div className="text-sm text-slate-400">Others</div>
              ...
              <Card className="bg-slate-900/50 border-slate-700/50 backdrop-blur-sm">
                ...
                <CardContent>
                  <div className="space-y-4">
                    ...
                    <div className="flex items-center justify-between">
                      <div className="flex items-center">
                        <Eye className="text-cyan-500 mr-2 h-4 w-4" />
                        <Label className="text-sm text-slate-400">
                          Hide Balance
                        </Label>
                      </div>
                    ...
                    <div className="flex items-center justify-between">
                      <div className="flex items-center">
                        <Fingerprint className="text-cyan-500 mr-2 h-4 w-4" />
                        <Label className="text-sm text-slate-400">
                          Biometric Login
                        </Label>
                      </div>
      ...
      <div className="flex items-center space-x-3">
        ...
        <div>
          <div className="flex items-center">
            ...
            <div className="ml-2 text-xs text-slate-500">{symbol}</div>
          </div>
